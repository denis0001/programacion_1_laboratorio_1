...
void mostrarEmpleados(eEmpleado emp[],int tam, eSector sectores[], int tamSector);
void agregarEmpleado(eEmpleado empleados[], int tam, eSector sectore[], int tamSector);
void eliminarEmpleado(eEmpleado *empleados, int tam, eSector sectores[], int tamSector);
void modificarEmpleado(eEmpleado empleados[], int tam, eSector sectore[], int tamSector);
...
void mostrarEmpleado(eEmpleado emp, eSector sectores[], int tamSector)
{
    ...
    cargarDescripcion(eSector sectores[], int tamSector, int idSector, char cadena[]);
...
if( indice == -1){
    ...
    mostrarEmpleado(eEmpleado emp, eSector sectores[], int tamSector);
...
void cargarDescripcion(eSector sectores[], int tamSector, int idSector, char cadena[])
{
    for(int i=0; i<tamSector; i++)
    {
        ...
        {
            strcmp(cadena, sectores[i].descripcion);
            break;
        }
    }
}
